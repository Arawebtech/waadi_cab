...
```
POST  https://mdk7v2f6-4001.inc1.devtunnels.ms/api/v1/vehicle-types 409 (Conflict)
...
### **Before Fix**
```bash
curl -X POST " https://mdk7v2f6-4001.inc1.devtunnels.ms/api/v1/vehicle-types" \
...
curl -s " https://mdk7v2f6-4001.inc1.devtunnels.ms/api/v1/vehicle-types?state_id=6891f4ae463073b51ec50c47"
