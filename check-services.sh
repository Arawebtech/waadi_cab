...
if curl -s -f  https://mdk7v2f6-4001.inc1.devtunnels.ms/health > /dev/null; then
    ...
    echo "   Response time: $(curl -s -w "%{time_total}s"  https://mdk7v2f6-4001.inc1.devtunnels.ms/health -o /dev/null)"
else
...
if curl -s -f  https://mdk7v2f6-4001.inc1.devtunnels.ms/api/v1/admin/dashboard > /dev/null; then
    echo "✅ Dashboard API endpoint is working"
    echo "   Response time: $(curl -s -w "%{time_total}s"  https://mdk7v2f6-4001.inc1.devtunnels.ms/api/v1/admin/dashboard -o /dev/null)"
else
...
echo "=========================="
echo "Backend: $(curl -s -f  https://mdk7v2f6-4001.inc1.devtunnels.ms/health > /dev/null && echo "✅ Running" || echo "❌ Not Running")"
echo "Dashboard: $(curl -s -f http://localhost:3000 > /dev/null && echo "✅ Running" || echo "❌ Not Running")"
echo "API: $(curl -s -f  https://mdk7v2f6-4001.inc1.devtunnels.ms/api/v1/admin/dashboard > /dev/null && echo "✅ Working" || echo "❌ Not Working")"
