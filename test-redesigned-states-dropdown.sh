...
test_endpoint " https://api.waadi.in/api/v1/admin/bookings?page=1&limit=5&status=paid" "No states filter" "200"
...
test_endpoint " https://api.waadi.in/api/v1/admin/bookings?page=1&limit=5&state_ids=" "Empty states array" "200"

echo -e "\n${YELLOW}6. Testing States with Other Filters${NC}"
today=$(date +%Y-%m-%d)
test_endpoint " https://api.waadi.in/api/v1/admin/bookings?page=1&limit=5&state_ids=6891f4ae463073b51ec50c47,6891fe63463073b51ec50e86&status=paid&date_from=$today&date_to=$today" "States with other filters" "200"

echo -e "\n${YELLOW}7. Testing Response Time${NC}"
RESPONSE_TIME=$(curl -s -w "%{time_total}" -o /dev/null " https://api.waadi.in/api/v1/admin/bookings?page=1&limit=5&state_ids=6891f4ae463073b51ec50c47,6891fe63463073b51ec50e86")
