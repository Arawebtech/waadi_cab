...
const io = new Server(server, {
    cors: {
      origin: process.env.NODE_ENV === 'production' 
        ? ['https://localhost','http://localhost:3000','https://book.waadi.in','http://localhost:3000', 'http://192.168.1.8:3001', "http://31.97.229.97:3001", "http://localhost:3001", "http://localhost:4001/", " http://localhost:4001/", "http://192.168.1.36:3000", "https://book.waadi.in", 'http://localhost:3000',  "http://localhost:3000:3001", "https://admin.waadi.in", "http://127.0.0.1:3000", "http://127.0.0.1:3002"]
        : ['https://localhost','http://localhost:3000','https://book.waadi.in','http://localhost:3000', 'http://192.168.1.8:3001', "http://31.97.229.97:3001", "http://localhost:3001", "http://localhost:4001/", " http://localhost:4001/", "http://192.168.1.36:3000", "https://book.waadi.in",  'http://localhost:3000',  "http://localhost:3000:3001", "https://admin.waadi.in", "http://127.0.0.1:3000", "http://127.0.0.1:3002"],
      credentials: true
    }
});
...
// CORS configuration
  app.use(cors({
    origin: process.env.NODE_ENV === 'production' 
      ?['https://localhost','http://localhost:3000','https://book.waadi.in', 'http://192.168.1.8:3001', "http://31.97.229.97:3001", "http://localhost:3001", " http://localhost:4001/", " http://localhost:4001/", "http://192.168.1.36:3000", "https://book.waadi.in", 'http://localhost:3000', "http://localhost:3000:3001", "https://admin.waadi.in", "http://127.0.0.1:3000", "http://127.0.0.1:3001","http://127.0.0.1:3002"]
      : ['https://localhost','https://book.waadi.in','http://localhost:3000', 'http://192.168.1.8:3001', "http://31.97.229.97:3001", "http://localhost:3001", " http://localhost:4001/", " http://localhost:4001/", "http://192.168.1.36:3000", "https://book.waadi.in", 'http://localhost:3000',  "http://localhost:3000:3001", "https://admin.waadi.in", "http://127.0.0.1:3000", "http://127.0.0.1:3001", "http://127.0.0.1:3002"],
    credentials: true
  }));
